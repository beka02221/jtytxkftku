/* game2.js – 3D Игра «Stack»
   ...
   2. Блоки – объёмные, с мягкими тенями, отражениями (отражение создаётся как перевёрнутый дубликат)
      ...
      Цвета выбираются случайно из набора классических вариантов: глубокий зелёный (#008000), тёмно-бирюзовый (#00C2A0),
      ядовито-зелёный (#39FF14) и два дополнительных оттенка (forest green и sea green).
...
// Новый набор плоских цветов для блоков (без яркого неонового зелёного)
const flatColors = [0x008000, 0x00C2A0, 0x39FF14, 0x228B22, 0x2E8B57];
